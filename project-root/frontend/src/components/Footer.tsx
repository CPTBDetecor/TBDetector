        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              Sistem deteksi dini Tuberkulosis paru-paru dengan pendekatan digital melalui kuesioner gejala, edukasi, dan informasi fasilitas kesehatan rujukan.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/facilities" className="text-gray-300 hover:text-white">Fasilitas Kesehatan</Link></li>
